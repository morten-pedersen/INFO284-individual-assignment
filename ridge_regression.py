...
print("R2 score on training data using Ridge: {:.4f}".format(Ridge.score(X_train_scaled, y_train)))
print("R2 score on test data using Ridge: {:.4f}".format(Ridge.score(X_test_scaled, y_test)), "\n")
