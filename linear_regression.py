...
LinearRegression = linear_model.LinearRegression(normalize = False)

LinearRegression.fit(X_train_scaled, y_train)

print("R2 score on training data using LinearRegression: {:.4f}".format(LinearRegression.score(X_train_scaled, y_train)))
print("R2 score on test data using LinearRegression: {:.4f}".format(LinearRegression.score(X_test_scaled, y_test)), "\n")
...
plt.xlabel("x")
plt.ylabel("y")
plt.title("LinearRegression score: {:.4f}".format(LinearRegression.score(X_test_scaled, y_test)))
plt.show()
